    ...
    function admin_add_role($id = null)
    {
        ...
        if (!empty($this->request->data->role_name)) {
            ...
            if (isset($d['role']->error)) {
                ...
                $this->redirect('admin/systeme/admin_add_role/id:' . $d['role']->id);
            }
        } elseif (!empty($id)) {
    ...
    function deleteRole($id)
    {
        ...
        if (isset($d->error)) {
            ...
            foreach ($d->error as $key => $value) {
                ...
                $this->Session->setFlash($value, 'bg-danger');
                $this->redirect('admin/systeme/admin_add_role/id:' . $id);
            }
        }

        $this->Session->setFlash('Le rôle a bien été supprimé', 'bg-success');
        $this->redirect('admin/systeme/admin_roles_list');
    }
    #endregion
    #region Tag 
    ...
    function admin_add_tag($id = null)
    {
        ...
        if (!empty($this->request->data->name)) {
            ...
            if (isset($d['tag']->error)) {
                ...
                $this->redirect('admin/systeme/admin_add_tag/id:' . $d['tag']->id);
            }
        } elseif (!empty($id)) {
    ...
    function deleteTag($id)
    {
        ...
        if (isset($d->error)) {
            ...
            foreach ($d->error as $key => $value) {
                ...
                $this->Session->setFlash($value, 'bg-danger');
                $this->redirect('admin/systeme/admin_add_tag/id:' . $id);
            }
        }

        $this->Session->setFlash('Le tag a bien été supprimé', 'bg-success');
        $this->redirect('admin/systeme/admin_tag_list');
    }
    #endregion
    #region Categories
    ...
    function admin_add_categorie($id = null)
    {
        ...
        if (!empty($this->request->data->name)) {
            ...
            if (isset($d['categorie']->error)) {
                ...
                $this->redirect('admin/systeme/admin_add_categorie/id:' . $d['categorie']->id);
            }
        } elseif (!empty($id)) {
    ...
    function deleteCategorie($id)
    {
        ...
        if (isset($d->error)) {
            ...
            foreach ($d->error as $key => $value) {
                ...
                $this->Session->setFlash($value, 'bg-danger');
                $this->redirect('admin/systeme/admin_add_categorie/id:' . $id);
            }
        }

        $this->Session->setFlash('La categorie a bien été supprimé', 'bg-success');
        $this->redirect('admin/systeme/admin_categorie_list');
    }
