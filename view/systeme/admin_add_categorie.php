...
?>
<form action="<?= (empty($categorie->id)) ? Router::url('admin/systeme/admin_add_categorie') : Router::url('admin/systeme/admin_add_categorie/id:' . $categorie->id)  ?>" method="POST" enctype="multipart/form-data">
