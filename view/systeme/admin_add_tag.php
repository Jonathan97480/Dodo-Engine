...
?>
<form action="<?= (empty($tag->id)) ? Router::url('admin/systeme/admin_add_tag') : Router::url('admin/systeme/admin_add_tag/id:' . $tag->id)  ?>" method="POST" enctype="multipart/form-data">
