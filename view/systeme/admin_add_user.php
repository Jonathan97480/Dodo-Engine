...
<form action="<?= (empty($user->t_users_id)) ? Router::url('admin/systeme/admin_add_user') :  Router::url('admin/systeme/admin_add_user/id:' . $user->t_users_id) ?>" method="POST" enctype="multipart/form-data">
