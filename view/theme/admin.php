...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="<?php echo Router::url('admin/systeme/admin_users_list'); ?>" aria-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-users"></i>
                    <span>Liste des utilisateurs</span>
                </a>
                <a class="nav-link collapsed" href="<?php echo Router::url('admin/systeme/admin_add_user'); ?>" aria-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-user"></i>
                    <span>ajouter un utilisateur</span>
                </a>
                <a class="nav-link collapsed" href="<?php echo Router::url('admin/systeme/admin_roles_list'); ?>" aria-expanded="true" aria-controls="collapsePages">
